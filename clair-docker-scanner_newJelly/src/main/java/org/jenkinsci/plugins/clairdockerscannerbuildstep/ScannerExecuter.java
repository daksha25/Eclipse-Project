...
public class ScannerExecuter {
	...
	public static int execute(AbstractBuild build, Launcher launcher,
			BuildListener listener, String artifactName,
			 String apiURL, String localImage,String localAnalyzerPath,String build_no)
		...
		args.add(localAnalyzerPath, "-endpoint", apiURL, "-my-address",
				localIP, localImage);
		...
		FilePath filename = Text_HTMLConverter.text_to_html(outFile,
				outfilFilePath1, out,build_no,target,build);
