...
public class Write_Json {
	...
	public static void main(String[] args) throws IOException, ParseException, org.json.simple.parser.ParseException {
		...
		GetParameters(encoded, id, jobname, environment,Jira_IP,FileName);

	}

	private static void GetParameters(String encoded, String id, StringBuilder jobname, ArrayList<String> environment, String Jira_IP, String FileName)
		...
		URL url = new URL("http://"+Jira_IP+"/rest/idalko-igrid/1.0/grid/10101/issue/" + id);
		HttpURLConnection conn = (HttpURLConnection) url.openConnection();
		conn.setRequestMethod("GET");
		conn.setRequestProperty("Accept", "application/json");
		conn.setRequestProperty("Authorization", "Basic " + encoded);
	...
	public static String json(ArrayList<String> comp_name, ArrayList<String> environment, ArrayList<String> jobName,
