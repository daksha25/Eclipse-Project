package com.cognizant.buildcounter;
...
public class BuildCounter {
	...
	public static void sendGet() throws Exception {
		...
		try {
			...
			JSONObject obj1 = (JSONObject) JSONValue.parse(projectInfo.toString());
			...
			for (String job : jobname) {
				...
				URL url1 = new URL("http://localhost:8080/job/" + job + "/api/json");
				...
				while ((inputLine1 = in1.readLine()) != null) {
					...
					JSONObject obj2 = (JSONObject) JSONValue.parse(jobInfo.toString());
