package com.plugin.MongoDB_RestorePlugin;
...
public class MongoDB_RestorePlugin extends Builder implements SimpleBuildStep {
    ...
    public MongoDB_RestorePlugin(String mongodb_path,String backup_path,String dbname) {
